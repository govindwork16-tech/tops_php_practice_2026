<!-- ========== INCLUDE: header.html ========== -->
<!-- Copy this block into every page above <main> -->
...
<div class="announce-bar">
  Free shipping on orders above ₹999 &nbsp;|&nbsp; <a href="products.php">Shop Now →</a>
</div>

<!-- Header -->
<header class="site-header">
  <div class="container">
    <a href="home.php" class="logo">Shop<span>Nova</span></a>
    <nav class="main-nav">
    ...
    <div class="header-actions">
      ...
      <a href="account_details.php" class="icon-btn" title="Account">
      ...
      <button class="hamburger icon-btn" style="display:none">
